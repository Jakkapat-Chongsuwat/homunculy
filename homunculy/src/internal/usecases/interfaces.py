"""
Use Case Protocols (Structural Interfaces).

Defines Protocol-based interfaces for all use cases using PEP 544.
Protocols allow structural subtyping - implementations don't need explicit inheritance.
