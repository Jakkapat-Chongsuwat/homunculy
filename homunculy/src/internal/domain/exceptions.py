...
class DomainException(Exception):
    ...
    def __str__(self) -> str:
        ...
        return _format_message(self.message, self.context)
...
class EntityNotFoundException(RepositoryException):
    ...
    def __init__(self, entity_type: str, entity_id: str):
        super().__init__(f"{entity_type} not found", entity_type=entity_type, entity_id=entity_id)
...
class DuplicateEntityException(RepositoryException):
    ...
    def __init__(self, entity_type: str, entity_id: str):
        super().__init__(
            f"{entity_type} already exists", entity_type=entity_type, entity_id=entity_id
        )
