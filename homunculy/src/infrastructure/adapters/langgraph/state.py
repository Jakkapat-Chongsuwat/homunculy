...
This is infrastructure-specific since it uses LangGraph's add_messages reducer.
Clean Architecture: Third-party dependencies belong in infrastructure layer.
"""
